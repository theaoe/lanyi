      ...
      <el-col :span="20" :xs="24">
          ...
          <el-row>
            ...
            <el-col :span="6">
              <el-form-item label="人员类别" prop="serviceReserve">
                <el-select
                  v-model="queryParams.serviceReserve"
            ...
            <el-col :span="6" v-if="queryParams.serviceReserve == 1">
              <el-form-item label="干部军衔" prop="militaryRank">
                <el-select
                  v-model="queryParams.militaryRank"
                  placeholder="请选择"
                  clearable
                  :style="{ width: '100%' }"
                >
            ...
            <el-col :span="6" v-if="queryParams.serviceReserve == 1">
              <el-form-item label="退役类别" prop="reserveStatus">
                <el-select
                  v-model="queryParams.reserveStatus"
                  placeholder="请选择预备役身份身份类别"
                  clearable
                  :style="{ width: '100%' }"
                >
        ...
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button
              ...
              size="mini"
              @click="handleAdd"
              v-hasPermi="['soldier:staffBase:add']"
              >新增</el-button
            >
          </el-col>
          <el-col :span="1.5">
            <el-button
              ...
              :disabled="single"
              @click="handleUpdate"
              v-hasPermi="['soldier:staffBase:edit']"
              >修改</el-button
            >
          </el-col>
          <el-col :span="1.5">
            <el-button
              ...
              :disabled="multiple"
              @click="handleDelete"
              v-hasPermi="['soldier:staffBase:remove']"
              >删除</el-button
            >
          </el-col>
          <el-col :span="1.5">
          ...
          <el-col :span="1.5">
            <el-tooltip
              class="item"
              effect="dark"
              content="导入前请先下载模板，按照模板导入用户基础信息"
              placement="bottom"
            >
              <el-button
                type="primary"
        ...
        >
          ...
          <el-table-column
            ...
            :formatter="educationBackgroundFormat"
          />
          <el-table-column
            label="健康状况"
            align="center"
           ...
           <!--  <el-row
            ...
            <el-row>
              ...
              <el-col :span="6">
                <el-form-item
                  label="安置单位类别"
                  prop="resettlementUnitsClass"
                >
                  <el-select
                    v-model="formData.resettlementUnitsClass"
              ...
              <el-col :span="6">
                <el-form-item label="安置单位类型" prop="resettlementUnitsType">
                  <el-select
