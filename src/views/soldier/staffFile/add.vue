                  ...
                  <el-col :span="6">
                    <el-form-item label="身份证" prop="idCard">
                      <el-input
                        ...
                        clearable
                        :style="{ width: '100%' }"
                        @blur="getBirthday(formData.idCard)"
                      >
                      </el-input>
                    </el-form-item>
                  </el-col>
...
import { validateIDCard, validateMobile } from "@/utils/validate.js";
  ...
  methods: {
    ...
    submitForm() {
      ...
      this.$refs["formData"].validate((valid) => {
        if (valid) {
          addStaffFile(this.formData).then((response) => {
